...
func init() {
	lang.AddLocale(&En{locale: "en", localesTranslator: en.New()})
}
...
func (e *En) RegisterDefaultTranslations(v *validator.Validate, trans ut.Translator) (err error) {
	...
	for _, t := range translations {
		...
		if t.customTransFunc != nil && t.customRegisFunc != nil {
			...
			err = v.RegisterTranslation(t.tag, trans, e.registrationFunc(t.tag, t.translation, t.override), t.customTransFunc)

		} else if t.customTransFunc == nil && t.customRegisFunc != nil {

			err = v.RegisterTranslation(t.tag, trans, t.customRegisFunc, e.translateFunc)

		} else {
			err = v.RegisterTranslation(t.tag, trans, e.registrationFunc(t.tag, t.translation, t.override), e.translateFunc)
		}
